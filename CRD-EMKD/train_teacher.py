...
from dataset.tinyimagenet import get_tiny_imagenet_dataloader
...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='cifar100', choices=['cifar10', 'cifar100', 'imagenet', 'tiny_imagenet'], help='dataset')
    ...
    opt.model_name = '{}_{}_{}_{}_{}_lr_{}_decay_{}_trial_{}'.format(opt.model, opt.block_depth[0], opt.block_depth[1], opt.block_depth[2], opt.dataset, opt.learning_rate, opt.weight_decay, opt.trial)
...
def main():
    ...
    if opt.dataset == 'cifar100':
        ...
        train_loader, val_loader = get_tiny_imagenet_dataloader(batch_size=opt.batch_size, num_workers=opt.num_workers)
        n_cls = 200
    else:
